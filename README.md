# 🌟 My Awesome Projects Collection
...
### 1. **Google Translate**
   ...
   - **GitHub Repository**: [Google Translate GitHub Repo](https://github.com/Avinash-Singh1/Translator-Text-and-Voice)
    - **Live Demo**: [Live Demo of Translator Application](https://translator-text-and-voice.onrender.com/translate) *(For the best experience, please open in incognito mode.)*
